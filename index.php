...
// Fetch counts of Open, Closed, and In-Progress tickets
$sql_open = "SELECT COUNT(*) as open_count FROM tickets WHERE status = 'open'";
$result_open = $conn->query($sql_open);
$open_count = $result_open->fetch_assoc()['open_count'];

$sql_closed = "SELECT COUNT(*) as closed_count FROM tickets WHERE status = 'closed'";
$result_closed = $conn->query($sql_closed);
$closed_count = $result_closed->fetch_assoc()['closed_count'];

$sql_in_progress = "SELECT COUNT(*) as in_progress_count FROM tickets WHERE status = 'In-Progress'";
$result_in_progress = $conn->query($sql_in_progress);
$in_progress_count = $result_in_progress->fetch_assoc()['in_progress_count'];

// Fetch all tickets for admin in descending order of creation date
$sql_all_tickets = "SELECT * FROM tickets ORDER BY created_at DESC";
$result_all_tickets = $conn->query($sql_all_tickets);
$all_tickets = $open_count + $closed_count + $in_progress_count;

if ($result_all_tickets->num_rows > 0) {
    $tickets = $result_all_tickets->fetch_all(MYSQLI_ASSOC);
} else {
    $tickets = [];
}
...
<head>
  ...
  <title>myHelpDesk - Dashboard</title>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown"
                ...
                <?php if ($new_open_count > 0) : ?>
                <span class="badge badge-danger badge-counter"><?php echo $new_open_count; ?></span><?php endif; ?>
              </a>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Open Request</div>
                      <div class="h1 mb-0 font-weight-bold text-gray-800"><?php echo $open_count; ?></div>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Closed Request</div>
                      <div class="h1 mb-0 font-weight-bold text-gray-800"><?php echo $closed_count; ?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h1 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $in_progress_count; ?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Total Ticket</div>
                      <div class="h1 mb-0 font-weight-bold text-gray-800"><?php echo $all_tickets; ?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
