...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 for ($i = 0; $i < $fileCount; $i++) {
     ...
     if (!empty($fileName)) {
         ...
         $allowTypes = array('jpg', 'jpeg', 'png', 'gif', 'pdf', 'doc', 'docx', 'zip', 'txt', 'rar');
         if (in_array($fileType, $allowTypes)) {
             ...
             $errorMessage = "Invalid file format. Allowed formats: jpg, jpeg, png, gif, pdf, doc, docx, zip, txt";
         }
     } else {
 ...
 // Combine file paths into a comma-separated string
 ...
 $sql = "INSERT INTO tickets (user_id, subject, description, siteid, fa, status, created_at, file_path) 
         VALUES ('$user_id', '$subject', '$description', '$siteid', '$fa', 'Open', NOW(), '$filePathsString')";
            ...
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <label for="exampleInputEmail1">Bussiness LOB</label>
                  <select class="form-control mb-3">
                    <option value="" disable select>Select LOB</option>
                    <option Value="Ericsson">Ericsson</option>
                    <option Value="Nokia">Nokia</option>
                  </select>
                    <div class="form-group">
                      <label for="exampleInputEmail1">FA Location</label>
                      <input type="text" class="form-control" name="fa" id="fa" aria-describedby="emailHelp"
                        placeholder="Enter FA Lation">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Site ID</label>
                      <input type="text" class="form-control" id="siteid" name="siteid" placeholder="Enter Site ID">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Suject</label>
                      <input type="text" class="form-control" id="subject" name="subject" placeholder="Ticket Subject">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" name="file[]" id="file" multiple onchange="displayFileNames(this)">
                ...
                <script>
                    function displayFileNames(input) {
                        ...
                        for (let i = 0; i < input.files.length; i++) {
                            ...
                            fileEntry.innerHTML = `<span>${fileName}</span><i class="fas fa-times-circle" onclick="removeFile(this)"></i>`;
                            fileNamesElement.appendChild(fileEntry);
                        }
                    }

                    function removeFile(icon) {
                        const fileEntry = icon.parentElement;
                        fileEntry.remove();
                    }
                </script>

                    </div>
                    <!-- Display success and error messages above the button -->
