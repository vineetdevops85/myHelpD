...
// Check if the user is not logged in or does not have admin role, then redirect to login page
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_user'])) {
    ...
    $sqlUpdate = "UPDATE users SET username = '$username', email = '$email', role = '$role' WHERE user_id = $userId";
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePage" class="collapse show" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="view_members.php">View Members</a>
          </div>
        </div>
      </li>
      <!-- <li class="nav-item">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Veiw Members</h1>
            <ol class="breadcrumb">
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="">
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editUserModal<?php echo $user['user_id']; ?>">Edit</button>
                ...
                <!-- Edit User Modal -->
                <div class="modal fade" id="editUserModal<?php echo $user['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editUserModalLabel<?php echo $user['user_id']; ?>" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editUserModalLabel<?php echo $user['user_id']; ?>">Edit User - <?php echo $user['username']; ?></h5>
                                ...
                                <form method="POST" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="role" name="role">
                                            ...
                                            <option value="customer" <?php if ($user['role'] == 'customer') echo 'selected'; ?>>Normal</option>
                                        </select>
                                    </div>
